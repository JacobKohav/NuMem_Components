...
function loadStatsPage()
{
	...
	for(i=2;i<rows;i++)
	{
		...
		var opteam = cols.item(1).innerHTML;
		var home = cols.item(2).innerHTML;
		home = parseInt(home);
		var away = cols.item(3).innerHTML;
		away = parseInt(away);
		if(home > away)
		{
			cols.item(4).innerHTML = 'Cu Boulder'
			wins++;
		}
		if(home < away)
		{
			cols.item(4).innerHTML = opteam;
			losses++;
		}
	}
...
function switchPlayers(playerNum)
{
	...
	document.getElementById('player_img').innerHTML = curr.img;
	...
	document.getElementById('avg_p_yards').innerHTML = (curr.pass_yards/curr.games_played);
	document.getElementById('avg_r_yards').innerHTML = (curr.receiving_yards/curr.games_played);
	document.getElementById('avg_rec_yards').innerHTML = (curr.rec_yards/curr.games_played);
